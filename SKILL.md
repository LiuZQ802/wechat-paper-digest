...
3. **Read the text** (chunk it if long) and pull out: journal name, paper title, first author's institution ("学校"), full author list, abstract, DOI, volume/issue/pages if assigned, and any dataset link mentioned. Also note enough for the paper's own citation (step 7).
